...
you can use z.infer<typeof ABC <span></span>> to create a type for typescript so that you don't have to write type declation twice. one for Zod and one for typescript.
